...
discord-auth-copy-all-button = © Скопировать весь текст
discord-auth-copy-all-popup = Текст скопирован!
discord-auth-open-channel-button = Открыть канал авторизации
